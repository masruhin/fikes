    ...
    <nav class="nav-menu" id="navMenu">
      ...
      <div class="nav-item has-dropdown">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-item">
            <a href="<?= $base_path ?>/page/tentang-fikes/sertifikat-akreditasi.php" class="dropdown-link">
              Sertifikat Akreditasi
            </a>
          </div>

          <div class="dropdown-item">
            <a href="<?= $base_path ?>/page/tentang-fikes/unduh-logo.php" class="dropdown-link"> Unduh Logo </a>
          </div>
